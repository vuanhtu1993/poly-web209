        ...
        <div className="max-w-xl lg:max-w-3xl">
          ...
          <form action="#" className="mt-8 grid grid-cols-6 gap-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="col-span-6">
              ...
              <input
                type="email"
                {...register('email', { required: "Dữ liệu bắt buộc", minLength: { value: 5, message: "Tối thiệu 5 ký tự" } })}
                className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
              />
            </div>
            ...
            <div className="col-span-6 sm:col-span-3">
              ...
              <input
                type="password"
                {...register('password', { required: "Dữ liệu bắt buộc", minLength: { value: 5, message: "Tối thiệu 5 ký tự" } })}
                className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
              />
            </div>
            ...
            <div className="col-span-6 sm:col-span-3">
              ...
              <input
                type="password"
                {...register('passwordConfirmation', { required: "Dữ liệu bắt buộc", minLength: { value: 5, message: "Tối thiệu 5 ký tự" } })}
                className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
              />
            </div>
